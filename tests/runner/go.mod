module github.com/ava-labs/subnet-cli/tests/runner

go 1.17

replace github.com/ava-labs/subnet-cli => ../..

require (
	github.com/ava-labs/avalanche-network-runner v0.0.0-20211220205928-4a40af6d2f7e
	github.com/ava-labs/avalanchego v1.7.2
	github.com/ava-labs/subnet-cli v0.0.0-00010101000000-000000000000
